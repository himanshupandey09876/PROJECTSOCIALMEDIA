    ...
    <div className='p-4 bg-white rounded-lg shadow-md text-sm flex flex-col gap-6'>
        ...
        <div className="h-20 flex flex-col gap-2 items-center">
            ...
            <div className="flex items-center gap-4 ">
                <div className="flex">
                    <Image src={"https://images.pexels.com/photos/19578755/pexels-photo-19578755/free-photo-of-woman-watching-birds-and-landscape.jpeg?auto=compress&cs=tinysrgb&w=800&lazy=load"}
